...
local function testEveryCatalogEntryGetsVersionedSourceTaggedModel()
  ...
  assertEqual(unknown.status, "metadata_baseline", "known vanilla baseline must remain usable without claiming curated certainty")
  assertTrue(not unknown.data_update_required, "known vanilla baseline must not be treated as an out-of-date catalog entry")
